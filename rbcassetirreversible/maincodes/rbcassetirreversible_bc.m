...
%=========================
dir = '../solutions/rbcassetirreversible_ss.mat';
load(dir);
...
% before.
% load '../solutions/WIP_rbcassetirreversible_bc.mat';
...
for iAprime = 1:pNumGridA
    ...
    rprime  = pAalpha*Aprime*vKprime.^(pAalpha-1) + (1-pDdelta)*(1-Lambdaprime);
...
rfuture    = pAalpha.*vGridA(futureShock).*vKprime.^(pAalpha-1) + (1-pDdelta)*(1-vLambda(iFuture));
...
vCnew = vGridA(vSimPath).*vKnew.^(pAalpha) - vI;
vLambdanew = 1-vCnew.^(pRiskAversion).*temp;
...
% save (mid)
%=========================  
save '../solutions/WIP_rbcassetirreversible_bc.mat';
toc;
...
% save (final)
%=========================  
save '../solutions/rbcassetirreversible_bc.mat';
