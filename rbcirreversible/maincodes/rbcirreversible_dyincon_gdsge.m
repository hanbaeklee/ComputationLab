...
vK = gdsgeSol.SimuRslt.K([1,1:requiredTime-1])';
vLambda = gdsgeSol.SimuRslt.muc([1,1:requiredTime-1])';
vC = gdsgeSol.SimuRslt.c([1,1:requiredTime-1])';
...
% save
save('../solutions/rbcirreversible_gdsge_EE.mat','EE');
...
fprintf('\n');
fprintf('======================== \n');
fprintf('dynamic consistency report for gdsge \n');
fprintf('======================== \n');
...
location = ['../figures/err_hist_gdsge.pdf'];
saveas(gcf, location);
