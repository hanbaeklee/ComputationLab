...
fprintf(' \n');
fprintf('======================== \n');
fprintf('Occbin solution report \n');
fprintf('======================== \n');
...
% save
save('../solutions/rbcirreversible_occbin_EE.mat','EE');
...
fprintf('\n');
fprintf('======================== \n');
fprintf('dynamic consistency report for occbin \n');
fprintf('======================== \n');
...
location = ['../figures/err_hist_occbin.pdf'];
saveas(gcf, location);
