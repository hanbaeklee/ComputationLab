...
%=========================
dir = '../solutions/rbcassetcvxadjcost_ss.mat';
load(dir);
ss = load('../solutions/rbcassetcvxadjcost_ss.mat');
...
% before.
% load '../solutions/WIP_rbcassetcvxadjcost_bc.mat';
...
tempC      = ((1 + pMmu*(vKprime./vK - (1-pDdelta)))./tempV1).^(1/pRiskAversion);
vr         = pAalpha*Aprime*vK.^(pAalpha-1) + (1-pDdelta) + (pMmu/2)*(vKprime./vK).^2 - (pMmu/2)*(1-pDdelta)^2;
vY         = vA.*vK.^(pAalpha);
...
% save (mid)
%=========================  
save '../solutions/WIP_rbcassetcvxadjcost_bc.mat';
toc;
...
% save (final)
%=========================  
save '../solutions/rbcassetcvxadjcost_bc.mat';
