...
pnumgridz   = 2;
[mtransz, vgridz] = ...
fnTauchen(prho, 0, psigma^2, pnumgridz, 1);
vgridz = exp(vgridz');            
if pnumgridz ==1
    mtransz = 1;
end
...
% before.
load '../solutions/WIP_ks1998endolaboruncertainty_ss.mat';
...
mpolaprime_new = w.*mgridz.*mpoln + (1+r).*vgrida' - c;
...
% save (mid)
%=========================
dir = '../solutions/WIP_ks1998endolaboruncertainty_ss.mat';
save(dir);
...
%save
%=========================
dir = '../solutions/ks1998endolaboruncertainty_ss.mat';
save(dir);
