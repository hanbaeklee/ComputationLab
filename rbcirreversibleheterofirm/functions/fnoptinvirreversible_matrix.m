function [kprimeopt] = fnoptinvirreversible_matrix(pbeta,vgridk,p,tj0,mlambdatemp)
    ...
    vfoc = futurevalderiv + mlambdatemp - p;
    vfoc_trans = vfoc';
    ...
    indxlow     = sub2ind(size(vfoc_trans),(1:plength1)',low');
    indxhigh    = sub2ind(size(vfoc_trans),(1:plength1)',high');
